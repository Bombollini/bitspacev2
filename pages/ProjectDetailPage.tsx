...
import { Plus, Users, Activity as ActivityIcon, LayoutGrid, Info, Search, Filter, UserPlus, FileText, ChevronDown, Download, Trash2, Edit2 } from "lucide-react";
import { generateProjectSummaryPDF, generateTaskListPDF, generateMemberWorkloadPDF, generateActivityLogPDF, generateMilestoneReportPDF } from "../utils/pdfGenerator";
        ...
        <div className="flex bg-black/20 p-1 rounded-xl border border-white/10 w-fit backdrop-blur-sm mx-auto lg:mx-0">
          {["milestones", "tasks", "overview", "members", "activity"].map((tab) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === tab ? "bg-neon-blue/10 text-neon-blue shadow-[0_0_10px_rgba(0,243,255,0.2)]" : "text-slate-500 hover:text-white hover:bg-white/5"}`}
            >
